...
![Alt text](assets/image-501.png)



### 4. 在mapper中如何传递多个参数？
![Alt text](assets/image-502.png)
...
![Alt text](assets/image-513.png)


> 我们最后把整个的工作流程串联起来，简单总结一下：

![Alt text](assets/image-514.png)
