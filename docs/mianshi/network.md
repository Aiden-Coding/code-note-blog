...
description: 计算机网络面试题，62道计算机网络八股文（2.2万字80张手绘图），面渣逆袭必看👍
head:
  - - meta
    - name: keywords
...
![Alt text](assets/image-583.png)



> 各个过程都使用了哪些协议？

![Alt text](assets/image-584.png)
...
![Alt text](assets/image-596.png)



这里还画了一张更详尽的图：

![Alt text](assets/image-597.png)
...
![Alt text](assets/image-604.png)



还有一种情况是已经失效的客户端发出的请求信息，由于某种原因传输到了服务器端，服务器端以为是客户端发出的有效请求，接收后产生错误。

![Alt text](assets/image-636.png)
...
![Alt text](assets/image-656.png)



发包的个数是指数性的增⻓。

![Alt text](assets/image-657.png)
...
![Alt text](assets/image-666.png)



可以这么形容：TCP 是打电话，UDP 是大喇叭。

![Alt text](assets/image-667.png)
